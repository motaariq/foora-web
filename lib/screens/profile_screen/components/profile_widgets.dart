...
Widget profileBody(context,UserInfo model)=>Column(
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      SizedBox(height: 10,),
                                                      Text(model.data!.age!,style: TextStyle(
                                                          color: Colors.grey[600],
                                                          fontSize: 18
                                                      ),)
                                                    ],
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      SizedBox(height: 10,),
                                                      Text(model.data!.weight!,style: TextStyle(
                                                          color: Colors.grey[600],
                                                          fontSize: 18
                                                      ),)
                                                    ],
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      SizedBox(height: 10,),
                                                      Text(model.data!.height!,style: TextStyle(
                                                          color: Colors.grey[600],
                                                          fontSize: 18
                                                      ),)
                                                    ],
