                                                                            ...
                                                                            Column(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Container(
                                                                                  ...
                                                                                  decoration: BoxDecoration(color: Colors.grey[100], borderRadius: BorderRadius.circular(10), border: Border.all(color: Colors.white)),
                                                                                  child: CoolDropdown(
                                                                                    dropdownList: forraCubit.get(context).areadropdownItemList,
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                ConditionalBuilder(
                                                                                    ...
                                                                                    builder: (context) => InkWell(
                                                                                          onTap: () {
                                                                                            forraCubit.get(context).createRequest(name: namerequestController.text, phone: phonerequestController.text, playersNumber: int.parse(playersrequestController.text), price: int.parse(pricerequestController.text), date: daterequestController.text, time: timerequestController.text, city: forraCubit.get(context).citycurrentindexdrop, area: forraCubit.get(context).areacurrentindexdrop!, location: locationrequestController.text);
                                                                                          },
                                                                                          child: Container(
                                                                                            width: 200,
                                                                                            height: 50,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                height: 440,
                                child: Center(
                                  child: recommendedCardList(context,
                                      forraCubit.get(context).gamesModel!),
                                ),
                              ),
                            ],
                          ),
